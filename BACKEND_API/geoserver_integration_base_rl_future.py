...
def upload_2_geoserver_rl_future():
    ...
    store_name_predictions = f'BASE_RL_RCP{scenario}_{task_id}_{user_id}'
    ...
    updated_layer_name_predictions = f'BASE_RL_RCP{scenario}_{task_id}_{user_id}'
