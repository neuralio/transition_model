...
def upload_2_geoserver_pecs_rl_past():
    ...
    INPUT_JSON_PATH = os.path.join(MAIN_DIR, "input_mongo_pecs_past.json")
    ...
    store_name_predictions = f'PECS_RL_PAST_{task_id}_{user_id}'
    ...
    updated_layer_name_predictions = f'PECS_RL_PAST_{task_id}_{user_id}'
