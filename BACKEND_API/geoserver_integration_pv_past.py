...
def upload_2_geoserver_pv_past():
    ...
    store_name_predictions = f'PV_Suitability_Predictions_Past_{task_id}_{user_id}'
    file_path_predictions = f'/opt/geoserver_data/data/ESA-AGENTS/BACKEND_API/Demo_With_Geoserver/PREDICTIONS/CSVs/{task_id}_{user_id}/PAST_PV_SUITABILITY_PREDICTIONS_UPDATED.nc'
    file_path_predictions_HOST = f'/app/PREDICTIONS/CSVs/{task_id}_{user_id}/PAST_PV_SUITABILITY_PREDICTIONS_UPDATED.csv'
    upload_layer_name_predictions = f'score'
    updated_layer_name_predictions = f'PV_Suitability_Predictions_Past_{task_id}_{user_id}'
    
    # Details for yield
    store_name_yield = f'PV_Suitability_Yield_Past_{task_id}_{user_id}'
    file_path_yield = f'/opt/geoserver_data/data/ESA-AGENTS/BACKEND_API/Demo_With_Geoserver/PREDICTIONS/CSVs/{task_id}_{user_id}/PAST_PV_YIELD.nc'
    file_path_yield_HOST = f'/app/PREDICTIONS/CSVs/{task_id}_{user_id}/PAST_PV_YIELD.csv'
    upload_layer_name_yield = f'annual_electricity_savings'
    updated_layer_name_yield = f'PV_Suitability_Yield_Past_{task_id}_{user_id}'
