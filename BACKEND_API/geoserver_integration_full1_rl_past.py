...
def upload_2_geoserver_full1_rl_past():
    ...
    INPUT_JSON_PATH = os.path.join(MAIN_DIR, "input_mongo_full1_past.json")
    PREDICTION_DIR = os.path.join(MAIN_DIR, "RESULTS_RL/FULL1_RL")
    ...
    store_name_predictions = f'FULL1_RL_PAST_{task_id}_{user_id}'
    ...
    updated_layer_name_predictions = f'FULL1_RL_PAST_{task_id}_{user_id}'
