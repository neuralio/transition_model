...
def upload_2_geoserver_rl_past():
    ...
    INPUT_JSON_PATH = os.path.join(MAIN_DIR, "input_mongo_base_past.json")
    PREDICTION_DIR = os.path.join(MAIN_DIR, "RESULTS_RL/BASE_RL")
    ...
    store_name_predictions = f'BASE_RL_PAST_{task_id}_{user_id}'
    file_path_predictions = f'/opt/geoserver_data/data/ESA-AGENTS/BACKEND_API/Demo_With_Geoserver/RESULTS_RL/BASE_RL/{task_id}_{user_id}/agent_data_over_time.nc'
    file_path_predictions_HOST = f'/app/RESULTS_RL/BASE_RL/{task_id}_{user_id}/agent_data_over_time.csv'
    upload_layer_name_predictions = f'decision'
    updated_layer_name_predictions = f'BASE_RL_PAST_{task_id}_{user_id}'
